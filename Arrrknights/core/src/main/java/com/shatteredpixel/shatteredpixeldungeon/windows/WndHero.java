	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			if (hero.name().equals(hero.className()))
				title.label( Messages.get(this, "title", hero.lvl, hero.className() ).toUpperCase( Locale.KOREAN ) );
			else
				title.label((hero.name() + "\n" + Messages.get(this, "title", hero.lvl, hero.className())).toUpperCase(Locale.KOREAN));
			...
			if(Dungeon.level.feeling == Level.Feeling.UNKNOWN){statSlot( Messages.get(this, "health"), "?/?" );}
			else if (hero.shielding() > 0) statSlot( Messages.get(this, "health"), hero.HP + "+" + hero.shielding() + "/" + hero.HT );
