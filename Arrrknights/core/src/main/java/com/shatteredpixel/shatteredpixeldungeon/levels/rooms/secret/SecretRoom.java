...
public abstract class SecretRoom extends SpecialRoom {
	...
	private static final ArrayList<Class<? extends SecretRoom>> ALL_SECRETS = new ArrayList<>( Arrays.asList(
			...
			SecretHoardRoom.class, SecretMazeRoom.class, SecretSummoningRoom.class, SecretCursedWeaponRoom.class));
	...
	private static float[] baseRegionSecrets = new float[]{4f, 4f, 4f, 4f, 4f, 0f, 4f, 4f};
