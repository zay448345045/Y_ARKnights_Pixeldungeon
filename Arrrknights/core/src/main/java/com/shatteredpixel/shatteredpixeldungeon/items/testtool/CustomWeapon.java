...
public class CustomWeapon extends MeleeWeapon {
    ...
    static{
        ...
        enchPrio.put(Dragonkill.class,0);//change from budding
        enchPrio.put(Elastic.class, 1);
        enchPrio.put(Grim.class, 0);
        enchPrio.put(Kinetic.class, 0);
        enchPrio.put(Lucky.class, 0);
        enchPrio.put(Overeating.class,2);//change from budding
        enchPrio.put(Penetrate.class,0);//change from budding
