...
//		}
		...
		if (InterlevelScene.mode != InterlevelScene.Mode.NONE) {
			if (Dungeon.depth == Statistics.deepestFloor
				...
				{
					if (Dungeon.mboss4 == 1 || Dungeon.mboss9 == 1 || Dungeon.mboss14 == 1 || Dungeon.mboss19 == 1)  GLog.n(Messages.get(this, "miniboss"));
				}
				if (Dungeon.isChallenged(Challenges.SPECIAL_BOSS) && Dungeon.depth == 25 && Dungeon.bossLevel())
				{
					if (Dungeon.mboss4 == 1 && Dungeon.mboss9 == 1 && Dungeon.mboss14 == 1 && Dungeon.mboss19 == 1) GLog.n(Messages.get(this, "miniboss_final"));
				}
