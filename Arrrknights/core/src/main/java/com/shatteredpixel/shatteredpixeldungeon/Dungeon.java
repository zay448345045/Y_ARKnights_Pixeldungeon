...
public class Dungeon {
	...
	public static boolean isSPChallenged( int mask ) {
		return (spchallenges & mask) != 0;
	}
	...
	public static Level newLevel() {
		...
		if (boc!=null && boc.isEquipped(hero) && (depth < 27 || depth > 30)) {
			Buff.affect(Dungeon.hero, Stamina.class, (Math.max(250+10*Dungeon.depth - Statistics.prevFloorMoves, Dungeon.depth+20)));
		}
	...
	public static void saveAll() throws IOException {
		if (hero != null && hero.isAlive()) {
			...
			GamesInProgress.set( GamesInProgress.curSlot, depth, challenges, spchallenges, hero );
	...
	public static void preview( GamesInProgress.Info info, Bundle bundle ) {
		...
		info.spchallenges = bundle.getInt( SPCHALLENGES );
