...
public class Generators_Misc extends Generators{
    ...
    private Class<? extends Runestone> idToStone(int id) {
        switch (id) {
            ...
            case 12:
                return StoneOfAdvanceguard.class;
            case 13:
            default:
                return SuperAdvanceguard.class;
        }
    }
    ...
    private Class<? extends Spell> idToSpell(int id){
        switch (id){
            ...
            case 20: return CurseSolidifying.class;
        }
    }
    ...
    private Class<? extends Item> idToMisc(int id){
        switch (id){
            ...
            case 17: return SakuraProof.class;
    ...
    private class SettingsWindow extends Window {
        ...
        private void updateText() {
            ...
            t_select.text(Messages.get(Generators_Misc.class, "select", Messages.get(item, "name")));
            layout();
        }
    }
}
