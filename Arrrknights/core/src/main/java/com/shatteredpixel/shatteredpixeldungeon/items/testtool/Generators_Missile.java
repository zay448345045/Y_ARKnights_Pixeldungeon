...
public class Generators_Missile extends Generators {
    {
    ...
    private Class<? extends MissileWeapon> idToMissile(int id) {
        switch (id) {
            ...
            case 3:
                return LightKnife.class;
            case 4:
                return PurgatoryKnife.class;
            case 5:
            ...
            case 11:
                return Bolas.class;
            case 12:
                return NormalMagazine.class;
            case 13:
                return Ragesawblade.class;
            case 14:
                return Thunderbolt.class;
            case 15:
    ...
    private class SettingsWindow extends Window {
        ...
        private void updateText() {
            t_select.text(Messages.get(Generators_Missile.class, "select", Messages.get(missileList.get(selected), "name")));
            layout();
        }
