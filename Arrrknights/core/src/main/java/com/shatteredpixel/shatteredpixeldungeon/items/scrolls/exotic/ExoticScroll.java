...
public abstract class ExoticScroll extends Scroll {
	...
	static{
		...
		regToExo.put(ScrollOfRage.class, ScrollOfSacrifice.class);
		exoToReg.put(ScrollOfSacrifice.class, ScrollOfRage.class);
		...
		regToExo.put(ScrollOfWarp.class, ScrollOfDominate.class);
		exoToReg.put(ScrollOfDominate.class, ScrollOfWarp.class);
	}
