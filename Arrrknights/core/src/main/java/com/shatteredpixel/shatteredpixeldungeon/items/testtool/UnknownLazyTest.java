...
public class UnknownLazyTest extends Generators {
    {
    ...
    public void execute(Hero hero, String action){
        if(action.equals(AC_GIVE)){
            ...
            new Torch().quantity(100).collect();
            ...
            new ScrollOfPsionicBlast().quantity(100).collect();
            new PotionOfCleansing().quantity(100).collect();
